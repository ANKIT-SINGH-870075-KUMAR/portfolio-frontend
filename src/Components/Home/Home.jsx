...
const Home = ({ timelines, youtubes, skills }) => {
  ...
  useEffect(() => {
    ...
    // use three.js library and create two sphere moon and venus in 3-D
    ...
    window.addEventListener('mousemove', (e) => {
      if (e.clientX <= window.innerWidth / 2) {
        ...
        venus.rotation.x -= constantspeed;
        venus.rotation.y += constantspeed;
      }
  ...
  return (
    <div className='home'>
      ...
      <div className="homeYoutube">
        <Typography variant='h3'>MY DESIGN</Typography>
